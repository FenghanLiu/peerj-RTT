...
# 预发布软件源，不建议启用
# deb https://mirrors.bfsu.edu.cn/ubuntu/ xenial-proposed main restricted universe multiverse
# deb-src https://mirrors.bfsu.edu.cn/ubuntu/ xenial-proposed main restricted universe multiverse